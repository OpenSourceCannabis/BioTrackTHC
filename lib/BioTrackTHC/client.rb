module BioTrackTHC
  ...
  class Client
    ...
    def setup_results(form, results)
      ...
      form.send(:'page2_Total', results[:page2_THC].to_f + (0.877 * results[:page2_THCA].to_f) + results[:page2_CBD].to_f + (0.877 * results[:page2_CBDA].to_f)) if fields.index('page2_Total')
      form.page2_THC_units = 1 if fields.index('page2_THC_units')
      form.page2_THCA_units = 1 if fields.index('page2_THCA_units')
      form.total_thc_units = 1 if fields.index('total_thc_units')
      ...
      form.page4_aspergillus = results[:page4_aspergillus] if fields.index('page4_aspergillus')
      form.send(:'page5_Residual Solvent', results['page5_Residual Solvent']) if fields.index('page5_Residual Solvent')
